	...
	<div class="splitter">
		...
		<div class="calculator">
			...
			<div class="calculator__grid">
				<div class="calculator__grid__item item-1">5%</div>
				<div class="calculator__grid__item item-2"></div>
				<div class="calculator__grid__item item-3"></div>
				<div class="calculator__grid__item item-4"></div>
				<div class="calculator__grid__item item-5"></div>
				<div class="calculator__grid__item item-6"></div>
			</div>
