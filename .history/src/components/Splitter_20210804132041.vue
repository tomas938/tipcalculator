		...
		<div class="calculator">
			<div class="up">
				...
				<div class="calculator__grid">
					<div class="calculator__grid__item item-1" @click="calcTip()">
						<p>5%</p>
					</div>
					<div class="calculator__grid__item item-2"><p>10%</p></div>
					<div class="calculator__grid__item item-3"><p>15%</p></div>
					<div class="calculator__grid__item item-4"><p>25%</p></div>
					<div class="calculator__grid__item item-5"><p>50%</p></div>
...
export default {
	...
	computed: {
		calcTip() {
			return (this.tip = this.bill * 0.05);
		},
	},
};
</script>
